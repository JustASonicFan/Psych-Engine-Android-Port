...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Psych Engine Team'],
			['KBFNFMODS',		'shadowmario',		'Main Coder Of The Port',					'https://twitter.com/Shadow_Mario_',	'0xFFFFDD33'],
			['NerySonicAwesome',			'riveroaken',		'Main Helper And Collab',				'https://twitter.com/river_oaken',		'0xFFC30085'],
			[''],
			['Engine Contributors'],
