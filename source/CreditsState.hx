...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Psych Engine Team'],
			['KBFNFMODS',		'KBFNFMODS',		'Main Coder Of The Port',					'https://youtube.com/channel/UCHJ2gyMtP_wUgALcVPeENSg',	'0xFFFFDD33'],
			['NerySonicAwesome',			'nerysonicawesome',		'Main Helper And Collab',				'https://youtube.com/channel/UC-22MauRVLz9U7QI-BDB9fQ',		'0xFFC30085'],
			[''],
			['Engine Contributors'],
