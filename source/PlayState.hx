...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Thats Stupid', 0.2], //From 0% to 19%
		['Your Trash', 0.4], //From 20% to 39%
		['Bro Wth', 0.5], //From 40% to 49%
		['Is That All', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Cool', 0.7], //69%
		['Well Done', 0.8], //From 70% to 79%
		['WOOHOO', 0.9], //From 80% to 89%
		['CLAP EM CHEEKS', 1], //From 90% to 99%
		['YEEEEEEESSS', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
        ...
        creditTxt.text = 'Port By KB And Nery';
